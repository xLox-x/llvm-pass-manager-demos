...
bool helper::CountFunctionCallsInModule(Module &module)
{
    ...
    for (Function &function : module)
    {
        ...
        LoadInst *counteCurrentValue = counterBuilder.CreateLoad(counterBuilder.getInt32Ty(), counterVariable);
    ...
    Constant *formatStringVariable = module.getOrInsertGlobal("call_msg", formatString->getType());
    ...
    for (auto &item : callCounterMap)
    {
        ...
        LoadInst *counterValue = printfWrapperBuilder.CreateLoad(printfWrapperBuilder.getInt32Ty(), item.second);
